...
export default function Input({ type = 'text', name, value, className, autoComplete, required, isFocused = false, handleChange, handleBlur, handleClick, handleFocus, placeholder, pattern, readOnly, hidden = false }) {
