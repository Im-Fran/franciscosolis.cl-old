...
Route::prefix('/account')->name('account')->middleware(['auth', '2fa', 'verified'])->group(function() {
    ...
    Route::prefix('/security')->name('.security')->group(function() {
        ...
        Route::prefix('/access')->name('.access')->group(function() {
            ...
            Route::prefix('/two-factor-auth')->name('.two-factor-auth')->middleware(['password.confirm'])->group(function() {
			...
			Route::prefix('/devices')->middleware(['password.confirm'])->name('.devices')->group(function() {
			...
			Route::prefix('/api-keys')->middleware(['password.confirm'])->name('.api-keys')->group(function(){
